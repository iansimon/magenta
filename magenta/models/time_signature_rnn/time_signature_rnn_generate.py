...
from magenta.models.time_signature_rnn import performance_sequence_generator
...
def run_with_flags(generator):
  ...
  Args:
    generator: The TimeSignatureRnnSequenceGenerator to use for generation.
  """
...
def main(unused_argv):
  ...
  generator = performance_sequence_generator.TimeSignatureRnnSequenceGenerator(
      model=performance_model.TimeSignatureRnnModel(config),
