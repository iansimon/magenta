...
from magenta.models.time_signature_rnn import performance_lib
from magenta.models.time_signature_rnn import performance_model
...
class TimeSignatureRnnSequenceGenerator(mm.BaseSequenceGenerator):
  """Performance RNN generation code as a SequenceGenerator interface."""
  ...
  def __init__(self, model, details,
    ...
    """Creates a TimeSignatureRnnSequenceGenerator.

    Args:
      model: Instance of TimeSignatureRnnModel.
    ...
    """
    super(TimeSignatureRnnSequenceGenerator, self).__init__(
...
def get_generator_map():
  ...
  def create_sequence_generator(config, **kwargs):
    return TimeSignatureRnnSequenceGenerator(
        performance_model.TimeSignatureRnnModel(config), config.details,
