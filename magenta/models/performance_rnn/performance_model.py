...
default_configs = {
    ...
    'beat_conditioned_performance_with_dynamics': PerformanceRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
            ...
            description='Beat-conditioned Performance RNN + dynamics'),
        magenta.music.OneHotEventSequenceEncoderDecoder(
            magenta.music.PerformanceOneHotEncoding(
                num_velocity_bins=32)),
        tf.contrib.training.HParams(
        ...
        num_velocity_bins=32,
        control_signals=[
            magenta.music.BeatPerformanceControlSignal(
                steps_per_second=magenta.music.DEFAULT_STEPS_PER_SECOND)
        ]),
