...
class EncoderPipeline(pipeline.Pipeline):
  ...
  def __init__(self, config, name):
    ...
    Args:
      config: A StructuredMelodyRnnConfig that specifies the encoder/decoder,
          pitch range, and what key to transpose into.
...
def get_pipeline(config, eval_ratio):
  ...
  Args:
    config: A StructuredMelodyRnnConfig object.
