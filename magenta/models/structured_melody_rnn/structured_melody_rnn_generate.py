...
from magenta.models.structured_melody_rnn import structured_melody_rnn_model
from magenta.models.structured_melody_rnn import structured_melody_rnn_sequence_generator
...
tf.app.flags.DEFINE_string(
    'config', 'self_similarity_rnn', 'The config to use.')
tf.app.flags.DEFINE_string(
    'output_dir', '/tmp/structured_melody_rnn/generated',
...
def run_with_flags(generator):
  ...
  Args:
    generator: The StructuredMelodyRnnSequenceGenerator to use for generation.
  """
...
def main(unused_argv):
  ...
  generator = structured_melody_rnn_sequence_generator.StructuredMelodyRnnSequenceGenerator(
      model=structured_melody_rnn_model.StructuredMelodyRnnModel(config),
