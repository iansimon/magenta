...
"""Tests for structured_melody_rnn_create_dataset."""

# internal imports
import tensorflow as tf
import magenta

from magenta.models.structured_melody_rnn import structured_melody_rnn_create_dataset
...
class MelodyRNNPipelineTest(tf.test.TestCase):
  ...
  def setUp(self):
    self.config = structured_melody_rnn_model.StructuredMelodyRnnConfig(
        None,
  ...
  def testMelodyRNNPipeline(self):
    ...
    pipeline_inst = structured_melody_rnn_create_dataset.get_pipeline(self.config,
                                                           eval_ratio=0.0)
